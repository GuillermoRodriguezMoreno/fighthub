...
export function NewUserDialog({ newUserDialogIsOpen, onSave, onCancel }: NewUserDialogProps) {
  const {
    register,
    handleSubmit,
    watch,
  ...
  const { mutate: newUserMutate, isSuccess, isError } = useNewUserMutation();
        ...
        <form onSubmit={handleSubmit(onSubmit)} noValidate>
          <div className="grid gap-4 py-4">
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <Input id="name" placeholder="coolNickname" className="col-span-3"
