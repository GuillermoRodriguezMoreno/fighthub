...
export function FighterProfilePage({ fighterProfile, club, fights, isAuthorized }: FighterProfilePageProps) {
    return (
        <>
...
export function FighterProfilePageContainer({ fighterProfileId }: FighterProfilePageContainerProps) {
    ...
    if (fighterProfileQuery.isLoading || fightsQuery.isLoading || clubQuery.isLoading) {
        return <LoadingSpinner />;
    }
    if (fighterProfileQuery.isError || fightsQuery.isError || fightsQuery.isError) {
    ...
    return <FighterProfilePage fighterProfile={fighterProfileQuery.data} isAuthorized={isAuthorized} club={club} fights={fights} />;
}